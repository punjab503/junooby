...
const Portfolio: React.FC = () => {
  ...
  const portfolioItems = [
    ...
    },
    {
      ...
      description: 'Engaging training content for enterprise clients',
    },
    {
      id: 11,
      title: 'Product Photography',
      category: 'commercial',
      image: 'https://images.pexels.com/photos/1667088/pexels-photo-1667088.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    ...
    },
    {
      ...
      description: 'Elegant coverage of charity gala event',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-2xl text-slate-400 max-w-4xl mx-auto">
            Explore our diverse collection of creative work spanning photography, video production, and commercial projects that showcase our expertise and artistic vision.
          </p>
        </div>
