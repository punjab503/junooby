        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <div className="space-y-6 text-slate-400 text-lg leading-relaxed">
              <p>
                Founded in 2014, MediaCorp began as a small team of passionate creatives with a shared vision: to push the boundaries of visual storytelling and create content that not only looks beautiful but also drives meaningful engagement.
              </p>
              <p>
